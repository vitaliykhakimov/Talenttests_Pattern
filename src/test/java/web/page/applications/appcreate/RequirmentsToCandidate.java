...
import util.Helper;
import web.elements.applications.appcreate.RequirmentsToCandidateElements;
...
public class RequirmentsToCandidate {
    ...
    public void selectRequireCompetencies() {
    ...
    public void selectWantedCompetencies() {
        Actions action = new Actions(driver);
    ...
    public void typeRequirmentsToCandidateFull()  {
